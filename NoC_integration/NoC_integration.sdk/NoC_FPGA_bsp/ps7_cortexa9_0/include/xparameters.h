...
/* Definitions for driver NI */
#define XPAR_NI_NUM_INSTANCES 1

/* Definitions for peripheral NI_0 */
#define XPAR_NI_0_DEVICE_ID 0
#define XPAR_NI_0_S00_AXI_BASEADDR 0x7AA00000
#define XPAR_NI_0_S00_AXI_HIGHADDR 0x7AA0FFFF
