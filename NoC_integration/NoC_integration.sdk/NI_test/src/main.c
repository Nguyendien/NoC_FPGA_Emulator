...
int main()
{
    ...
    for (i=1; i<16; i++){
		...
		NETWORK_INTERFACE_mWriteReg(XPAR_NETWORK_INTERFACE_0_S00_AXI_BASEADDR, NETWORK_INTERFACE_S00_AXI_SLV_REG2_OFFSET, 1);
		//printf("Sending data back from IP...\n\r");

		NETWORK_INTERFACE_mWriteReg(XPAR_NETWORK_INTERFACE_0_S00_AXI_BASEADDR, NETWORK_INTERFACE_S00_AXI_SLV_REG2_OFFSET, 0);
		//printf("Sending data back from IP...\n\r");
