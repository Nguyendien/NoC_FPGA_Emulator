 ...
 *      Author: vegan
 *     Compile: nvcc main.cu DCTHEVC.cu DCTHEVCdct.cu
 */
...
/*
CPU functions for printing and initializing matrixes
*/
__host__ Void printSqMtxPel(Pel *mtx, Int N);
__host__ Void printSqMtxCoeff(TCoeff *mtx, Int N);
__host__ Void setZeroPel(Pel *mtx, Int N);
__host__ Void setZeroCoeff(TCoeff *mtx, Int N);

int main(void)
{
	/*
	Pel for brute force CPU method;
	TCoeff for threaded.
	*/
	/*
	4x4 matrix
